...
class KeywordMatcherGPT:
    def __init__(self):
        ...
        self.client = OpenAI(api_key=api_key, base_url="https://www.dmxapi.cn/v1")
...
def main():
    ...
    for model_name in model_names:
        ...
        paths["desc_output_dir"] = f"./LAT/description/{method}"
        ...
        descriptions_path = os.path.join(
            desc_dir, f"adversarial_{model_name}.txt"
        )
        results_path = os.path.join(
            desc_dir, f"keyword_matching_gpt_{model_name}.json"
        )
