...
class ClipLaionB16FeatureExtractor(BaseFeatureExtractor):
    def __init__(self):
        super(ClipLaionB16FeatureExtractor, self).__init__()
        self.model = CLIPModel.from_pretrained("laion/CLIP-ViT-B-16-laion2B-s34B-b88K")
        self.tokenizer = AutoTokenizer.from_pretrained("laion/CLIP-ViT-B-16-laion2B-s34B-b88K")
