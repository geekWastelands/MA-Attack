...
class ClipLaionL14FeatureExtractor(BaseFeatureExtractor):
    def __init__(self):
        super(ClipLaionL14FeatureExtractor, self).__init__()
        self.model = CLIPModel.from_pretrained("laion/CLIP-ViT-L-14-laion2B-s32B-b82K")
        self.tokenizer = AutoTokenizer.from_pretrained("laion/CLIP-ViT-L-14-laion2B-s32B-b82K")
